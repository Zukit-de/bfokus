var data = [
    {
        ...
        params: {
            // text: 'Below are the results for "kaffeemaschinen"</mark>. Price range <mark tabindex="-1">80 to 200 euros</mark> and 4 stars or more for the first 10 products.',
            text: 'Below are the results for "kaffeemaschinen". Price range 80 to 200 euros and 4 stars or more for the first 10 products.',
